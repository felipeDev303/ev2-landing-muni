...
const infoSlides = [
  {
    ...
    description:
      "Realiza tu trámite de permiso de circulación en línea o en la nueva oficina municipal.",
    image: "/public/permiso-circulacion.jpeg",
  },
  {
    title: "Taller Comunitario sobre el Cambio Climático",
    description:
      "Participa en el taller gratuito para aprender sobre el impacto y soluciones locales.",
    image: "/public/publicaciones.jpg",
  },
  {
    title: "Taller de Acondicionamiento Físico",
    description:
      "Inscríbete en las clases de acondicionamiento físico para todas las edades.",
    image: "/public/acondicionamiento.jpg",
  },
  {
    title: "Nueva Ubicación Unidad de Tránsito",
    description:
      "La Unidad de Tránsito se ha trasladado a José Joaquín Pérez 500. Más espacio y mejor atención.",
    image: "/public/oficina.jpg",
  },
  {
    title: "Movilización para Estudiantes Vespertinos",
    description:
      "Solicita tu pase para el transporte municipal destinado a estudiantes vespertinos.",
    image: "/public/bus-estudiantes.jpg",
  },
  {
    title: "Programa Beca Municipal 2025",
    description:
      "Infórmate y postula a la beca municipal para estudiantes de educación superior.",
    image: "/public/bec2.jpg",
  },
  {
    title: "Transmisión del Consejo",
    description:
      "Sigue en vivo las sesiones del consejo municipal todos los Lunes a las 10:00 hrs.",
      ...
      <div className="w-full max-w-xs md:max-w-2xl lg:max-w-3xl mx-auto px-2 sm:px-0">
        <Carousel
          ...
          prevArrow={({ handlePrev }) => (
            <button
              onClick={handlePrev}
              className="absolute left-2 top-1/2 -translate-y-1/2 z-10 p-2 bg-white/80 rounded-full shadow hover:bg-cyan-200"
            >
          ...
          nextArrow={({ handleNext }) => (
            <button
              onClick={handleNext}
              className="absolute right-2 top-1/2 -translate-y-1/2 z-10 p-2 bg-white/80 rounded-full shadow hover:bg-cyan-200"
            >
              ...
              {Array.from({ length }).map((_, i) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full ${
                    activeIndex === i ? "bg-cyan-500" : "bg-gray-300"
                  }`}
        ...
        >
          {infoSlides.map((slide, idx) => (
            <div
              key={idx}
              className="flex flex-col justify-center items-center bg-white rounded-lg overflow-hidden shadow p-4 md:p-8"
            >
