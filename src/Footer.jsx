      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="flex gap-4 mt-2">
            <li>
              <a href="https://www.instagram.com/municholchol_oficial/" aria-label="Instagram" className="text-xs bg-transparent text-gray-300 font-light hover:text-cyan-400 border-none shadow-none flex items-center px-3 py-2 rounded">
                <FaInstagram className="w-5 h-5 mr-2" /> Instagram
              </a>
            </li>
            <li>
              <a href="https://www.facebook.com/p/Municipalidad-de-Cholchol-100065025870874/" aria-label="Facebook" className="text-xs bg-transparent text-gray-300 font-light hover:text-cyan-400 border-none shadow-none flex items-center px-3 py-2 rounded">
