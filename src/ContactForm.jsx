    ...
    >
      ...
      >
        ...
        <div>
          <label
            htmlFor="nombre"
            className="block text-xs font-bold text-cyan-700 tracking-widest uppercase mb-1"
          >
            Nombre
          </label>
          <input
        ...
        >
          {submitting ? (
            ...
            <span className="flex items-center gap-2 justify-center group">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5 transition-transform duration-300 group-hover:translate-x-1 group-hover:-rotate-12 text-cyan-50"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
